...
#
get_filename_component(filename "/home/karry/SailfishOS/projects/harbour-camera-buddy/dependencies/libgphoto2-2.5.29.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/karry/SailfishOS/projects/harbour-camera-buddy/cmake-build-debug/dependencies/GPhoto2-prefix/src/GPhoto2" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-GPhoto2${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-GPhoto2${i}")
