...
#
get_filename_component(filename "/home/karry/SailfishOS/projects/harbour-camera-buddy/dependencies/libusb-1.0.26.tar.bz2" ABSOLUTE)
get_filename_component(directory "/home/karry/SailfishOS/projects/harbour-camera-buddy/cmake-build-debug/dependencies/libusb-prefix/src/libusb" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libusb${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libusb${i}")
