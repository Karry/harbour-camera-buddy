...
#
get_filename_component(filename "/home/karry/SailfishOS/projects/harbour-camera-buddy/dependencies/libtool-2.4.6.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/karry/SailfishOS/projects/harbour-camera-buddy/cmake-build-debug/dependencies/libltdl-prefix/src/libltdl" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libltdl${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libltdl${i}")
